...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('product')->group(function () {
            ...
            Route::get('/guarantee/create/{product}', [ProductGuaranteeController::class, 'create'])->name('admin.market.guarantee.create');
            Route::post('/guarantee/store/{product}', [ProductGuaranteeController::class, 'store'])->name('admin.market.guarantee.store');
            Route::delete('/guarantee/destroy/{product}/{guarantee}', [ProductGuaranteeController::class, 'destroy'])->name('admin.market.guarantee.destroy');
        });
