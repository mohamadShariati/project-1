                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{Str::limit($single_sms->body,12, '...') }}</td>
                            <td>{{jalaliDate($single_sms->published_at)}}</td>
                            <td>
                                <input type="checkbox" id="{{$single_sms->id}}" onchange="changeStatus({{$single_sms->id}})" data-url="{{route('admin.notify.sms.status',$single_sms->id)}}" @if ($single_sms->status == 1)  checked @endif>
                            </td>
