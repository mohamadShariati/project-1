                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="title" value="{{old('title',$page->title)}}" type="text" class="form-control form-control-sm">
                                </div>
                                @error('title')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                   ...
                                   <option class="form-control form-control-sm" value="0" @if (old('status',$page->status)===0) selected @endif>غیر فعال</option>
                                   <option class="form-control form-control-sm" value="1" @if (old('status',$page->status)===1) selected @endif>فعال</option>
                                </select>
                                </div>
                            </section>
                             <section class="col-12">
                               ...
                               <div class="form-group">
                                ...
                                <input name="tags" value="{{old('tags',$page->tags)}}" class="form-control form-control-sm" type="hidden" id="tags">
