  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form id="form" action="{{route('admin.content.faq.update',$faq->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{method_field('put')}}
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="tags" value="{{old('tags',$faq->tags)}}" class="form-control form-control-sm" type="hidden" id="tags">
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" name="question" id="question" rows="2">{{old('question',$faq->question)}}</textarea>
                            </div>
                            @error('question')
                                <strong class="alert-required text-danger">
                                  <strong>
